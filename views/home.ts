...
// Define the URLs variable for demonstration purposes
const URLs = 'https://aisplay.ais.co.th/portal/'; // Replace with your desired URL

// Define the route to render the HTML content
router.get('/', (req: Request, res: Response) => {
    ...
    <head>
        ...
        <meta name="keywords" content="กู้เงิน, จํานําเล่มทะเบียนรถ, นาโนไฟแนนซ์, สินเชื่อส่วนบุคคล, รถแลกเงิน, เงินด่วน, ต้องการเงินด่วน">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>SMARTCARD | สินเชื่อศักดิ์สยาม สินเชื่อเพื่อสังคม | บริการสินเชื่อทะเบียนรถทุกชนิด | ดอกเบี้ยถูก บริการดี มีมาตรฐาน โทร 055 440 372</title>
